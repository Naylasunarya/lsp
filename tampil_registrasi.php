...
<!-- sidebar -->
	...
	<div class="container">
  		<center>
            ...
            <h4 class="mb-0 fw-bold text-center">DATA REGISTRASI PESERTA UJIAN</h4>
          </div>
          	<a href="print_registrasi.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Print</a>
  			...
  			<a href="data_tanggal.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Lihat Data pertanggal</a>
