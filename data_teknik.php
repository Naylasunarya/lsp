      ...
      <div class="container col-md-10">
        <center>
          <table border="1" class="table table-bordered">
            ...
            <h4 class="mb-0 fw-bold text-center">DATA JADWAL UJIAN LISENSI TEKNIK</h4>
          </div>
            ...
            <?php
      $sql = "SELECT * FROM jadwal WHERE jenis_ujian='TEKNIK'";
       ...
       $query = mysqli_query($kon, $sql); 
                ...
                <p>Total: <?php echo mysqli_num_rows($query) ?></p> 
                	<a href="print_teknik.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Print</a>
      </div>
    </div>
